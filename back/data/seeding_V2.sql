...
INSERT INTO "project" ("title","description","status","color","area","pro_id","consumer_id")
    VALUES
        ('Projet cover','cover dos','accepté','true','dos',1,1),
        ('Projet tatoo Lion','fjkekjhezk','accepté','true','dos',2,1);

INSERT INTO "tattoo" ("tattoo_picture_path","pro_id")
    VALUES
        ('https://res.cloudinary.com/1',1),
        ('https://res.cloudinary.com/2',2),
        ('https://res.cloudinary.com/3',2),
        ('https://res.cloudinary.com/4',1);


INSERT INTO "appointment" ("title","note","beginning_hour","ending_hour","pro_id","project_id")
    VALUES
        ('rdv 1','penser à cicatrices',NOW()+'1day',(NOW()+'1day'+'1hour'),1,1),
        ('rdv machin','penser à ceci',NOW()+'2day',NOW()+'2day'+'1hour',1,2),
        ('rdv truc','penser à cela',NOW()+'3day',NOW()+'3day'+'1hour',2,1);

INSERT INTO "message" ("content","project_id","pro_id","consumer_id")
    VALUES
        ('Bonjour je veux un tatouage',1,null,1),
        ('Quel type de tatouage?',1,1,null);

INSERT INTO "categorise"("pro_id","style_id")
    VALUES
        (1,1),
        (1,2),
        (1,3),
